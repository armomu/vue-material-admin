...
INSERT INTO `permission` (`id`, `name`, `code`, `type`, `parentId`, `path`, `redirect`, `icon`, `component`, `layout`, `keepAlive`, `method`, `description`, `show`, `enable`, `order`) VALUES (41, 'Tree Menu', 'treeMenu', '', NULL, '/tree-menu', '', 'mdi-file-tree', '/src/layout/index.vue', NULL, NULL, NULL, NULL, 1, 1, NULL);
INSERT INTO `permission` (`id`, `name`, `code`, `type`, `parentId`, `path`, `redirect`, `icon`, `component`, `layout`, `keepAlive`, `method`, `description`, `show`, `enable`, `order`) VALUES (42, 'Two', 'Two', '', 41, '/aa/a1', '', 'mdi-alpha-t', '/src/layout/index.vue', NULL, NULL, NULL, NULL, 1, 1, NULL);
INSERT INTO `permission` (`id`, `name`, `code`, `type`, `parentId`, `path`, `redirect`, `icon`, `component`, `layout`, `keepAlive`, `method`, `description`, `show`, `enable`, `order`) VALUES (43, 'Two1', 'Two1', '', 42, '/aa/a1/2d', '', 'mdi-alpha-t', '/src/views/feedback/no.vue', NULL, NULL, NULL, NULL, 1, 1, NULL);
INSERT INTO `permission` (`id`, `name`, `code`, `type`, `parentId`, `path`, `redirect`, `icon`, `component`, `layout`, `keepAlive`, `method`, `description`, `show`, `enable`, `order`) VALUES (44, 'One1', 'One1', '', 41, '/aa/a1/1d', '', 'mdi-alpha-o', '/src/views/feedback/no.vue', NULL, NULL, NULL, NULL, 1, 1, NULL);
INSERT INTO `permission` (`id`, `name`, `code`, `type`, `parentId`, `path`, `redirect`, `icon`, `component`, `layout`, `keepAlive`, `method`, `description`, `show`, `enable`, `order`) VALUES (45, 'One2', 'One2', '', 41, '/aa/a1/2d', '', 'mdi-alpha-o', '/src/views/feedback/no.vue', NULL, NULL, NULL, NULL, 1, 1, NULL);
COMMIT;
